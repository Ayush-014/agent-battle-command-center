...
POST   /api/queue/assign       - Manually assign task (micromanager)
...
POST   /api/execute/step       - Execute single step (micromanager)
POST   /api/execute/approve    - Approve step
POST   /api/execute/reject     - Reject step
...
execution_step      - Step completed (micromanager)
...
// UI Mode
type UIMode = 'overseer' | 'micromanager';
```
