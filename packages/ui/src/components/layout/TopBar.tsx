import { Settings, Bell, Zap, Clock, RotateCw, MessageSquare, RefreshCcw } from 'lucide-react';
import { ResourceBar } from '../resources/ResourceBar';
import { useUIStore } from '../../store/uiState';
import { useState } from 'react';

export function TopBar() {
  const { mode, setMode, alerts, toggleAlertsPanel, chatPanelOpen, toggleChatPanel } = useUIStore();
