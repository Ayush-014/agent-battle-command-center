...
- Includes 5 concrete mission examples (3 Python, 1 JS, 1 TS) showing ideal 3-step execution
...
The agents container includes **Python 3.11** and **Node.js 20 LTS** with `typescript` and `tsx`:
...
- Security: `shell.py` blocks dangerous Node.js modules (`child_process`, `fs`, `net`, `http`) just like Python's `subprocess`/`os.system`
